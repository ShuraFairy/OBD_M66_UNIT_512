...
extern int isfreetx(int buf);

extern void settxtransmit(int buf);
 
extern int sendnormalmsg(int prio, long txidentifier,unsigned int dataLength, unsigned int data1, unsigned int data2, unsigned int data3, unsigned int data4 );
...
//extern void rxECAN1(int message);

//extern void Can1Tasks(void);
